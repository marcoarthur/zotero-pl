use utf8;
package MyApp::Schema::Result::RetractedItem;
...
=head1 TABLE: C<retractedItems>

=cut

__PACKAGE__->table("retractedItems");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:lD5kUXz5H41pMVZR3UPDBQ
