use utf8;
package MyApp::Schema::Result::CollectionRelation;
...
Related object: L<MyApp::Schema::Result::RelationPredicate>
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:pq+JjSUiqcwAYEXrFpx7TQ
